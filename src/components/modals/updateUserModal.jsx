...
const UpdateUserModal = ({ isOpen, onResolve, onReject,user }) => {
    ...
    const defaultValues = {nom: user.nom, prenom: user.prenom,tel: user.tel, password: user.password, role: user.role};
  ...
  return (
    ...
    <div className="mb-3">
            ...
            ease-soft block w-full appearance-none rounded-lg border border-solid border-blue-300
             bg-white bg-clip-padding px-3 py-2 font-normal text-blue-700 outline-none transition-all
              placeholder:text-blue-500 focus:border-blue-300 focus:outline-none" id="nom" placeholder="Entrer le nom" autoFocus />
             )}/>
            ...
            <input type="tel" {...field} className="focus:shadow-soft-primary-outline text-sm leading-5.6 
            ease-soft block w-full appearance-none rounded-lg border border-solid border-blue-300
             bg-white bg-clip-padding px-3 py-2 font-normal text-blue-700 outline-none transition-all
              placeholder:text-blue-500 focus:border-blue-300 focus:outline-none" id="tel" placeholder="Téléphone" />
             )}/>
