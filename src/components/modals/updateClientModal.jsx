...
function UpdateClientModal({ isOpen, onResolve, onReject,client }) {
    ...
    const defaultValues = {nom: client?.nom, prenom: client?.prenom,tel: client?.tel};
  ...
  return (
    <>
     <Dialog header="Mettre à jour un client" visible={isOpen} onHide={() => onReject(false)} className="w-1/2">
