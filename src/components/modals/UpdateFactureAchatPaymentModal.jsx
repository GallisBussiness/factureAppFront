...
function UpdateFactureAchatPaymentModal({ isOpen, onResolve, onReject,factureAchat,fournisseur }) {
  ...
  return (
    <>
     <Dialog header="PAYMENT FACTURE FOURNISSEUR" visible={isOpen} onHide={() => onReject(false)} className="w-1/2">
